...
import { HiColorSwatch, HiCode, HiCalendar, HiCamera } from 'react-icons/hi'
...
const divisions = [
  {
    icon: HiColorSwatch,
    title: 'Desainer',
    desc: 'Ciptakan visual memukau, desain UI/UX, dan identitas merek yang menghidupkan misi kami.',
  ...
  },
  {
    icon: HiCode,
    title: 'Pengembang',
    desc: 'Bangun aplikasi dan website tangguh yang menggerakkan komunitas dan menciptakan dampak.',
  ...
  },
  {
    ...
    desc: 'Rencanakan dan laksanakan acara berkesan yang mempertemukan orang-orang dan memicu kolaborasi.',
  ...
  },
  {
    icon: HiCamera,
    title: 'Media',
    desc: 'Abadikan momen, kelola media sosial, dan ceritakan kisah inspiratif yang memperkuat suara kami.',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold mt-3 mb-4">
              Temukan{' '}
              <span className="text-gradient">Peranmu</span>
            </h2>
            <p className="text-gray-400 max-w-xl mx-auto">
              Pilih divisi yang sesuai dengan minat dan keahlianmu. Setiap peran
              sangat penting untuk membuat Volunext luar biasa.
            </p>
          </motion.div>
          ...
          >
            {divisions.map((div) => (
              <motion.div key={div.title} variants={cardVariants}>
                <TrueFocus
                ...
                >
                  <motion.div
                    ...
                    className="glass-card p-6 flex flex-col items-center text-center border border-white/5 hover:border-primary/40 transition-all duration-300 cursor-default relative overflow-hidden group h-full"
                  >
                    <div
