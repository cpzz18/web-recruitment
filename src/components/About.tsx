            ...
            >
              {features.map((feature, i) => (
                <motion.div
                  ...
                  className="glass-card p-6 flex gap-5 items-start group cursor-default transition-shadow duration-300 hover:shadow-lg hover:shadow-primary/5"
                >
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-all duration-300 group-hover:scale-110">
