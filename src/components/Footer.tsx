...
import { FaInstagram, FaTwitter, FaLinkedinIn, FaGithub, FaEnvelope } from 'react-icons/fa'
            ...
            >
              ...
              <ul className="space-y-2">
                {footerLinks.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-gray-500 hover:text-primary transition-colors text-sm">
                      {link.label}
                    </a>
                  </li>
                ))}
